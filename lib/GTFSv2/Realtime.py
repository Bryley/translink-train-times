...
from .GTFSv2.Realtime import FeedHeader
from .GTFSv2.Realtime import TranslatedString
from .GTFSv2.Realtime import TripDescriptor
from .GTFSv2.Realtime import TripUpdate
from .GTFSv2.Realtime.TripUpdate import StopTimeUpdate
...
class FeedMessage(betterproto.Message):
    ...
    header: "DHeader" = betterproto.message_field(1)
    # Contents of the feed.
    entity: List["DEntity"] = betterproto.message_field(2)
...
class FeedHeader(betterproto.Message):
    ...
    incrementality: FeedHeader.Incrementality = betterproto.enum_field(2)
...
class FeedEntity(betterproto.Message):
    ...
    trip_update: "RipUpdate" = betterproto.message_field(3)
...
class TripUpdate(betterproto.Message):
    ...
    trip: "RipDescriptor" = betterproto.message_field(1)
    ...
    stop_time_update: List[TripUpdate.StopTimeUpdate] = betterproto.message_field(2)
...
class TripUpdateStopTimeUpdate(betterproto.Message):
    ...
    arrival: TripUpdate.StopTimeEvent = betterproto.message_field(2)
    departure: TripUpdate.StopTimeEvent = betterproto.message_field(3)
    schedule_relationship: StopTimeUpdate.ScheduleRelationship = betterproto.enum_field(
        5
    )
...
class VehiclePosition(betterproto.Message):
    ...
    # A percentage value representing the degree of passenger occupancy of the
    ...
    # capacity, and current operating regulations allow. It is possible that the
    # value goes over 100 if there are currently more passengers than what the
    # vehicle was designed for. The precision of occupancy_percentage should be
    # low enough that you can't track a single person boarding and alighting for
    # privacy reasons. This field is still experimental, and subject to change.
    # It may be formally adopted in the future.
...
class Alert(betterproto.Message):
    ...
    active_period: List["Nge"] = betterproto.message_field(1)
    ...
    url: "RanslatedString" = betterproto.message_field(8)
    # Alert header. Contains a short summary of the alert text as plain-text.
    header_text: "RanslatedString" = betterproto.message_field(10)
    # Full description for the alert as plain-text. The information in the
    # description should add to the information of the header.
    description_text: "RanslatedString" = betterproto.message_field(11)
    # Text for alert header to be used in text-to-speech implementations. This
    # field is the text-to-speech version of header_text. This field is still
    # experimental, and subject to change. It may be formally adopted in the
    # future.
    tts_header_text: "RanslatedString" = betterproto.message_field(12)
    ...
    # description_text. This field is still experimental, and subject to change.
    # It may be formally adopted in the future.
    tts_description_text: "RanslatedString" = betterproto.message_field(13)
...
class TripDescriptor(betterproto.Message):
    ...
    schedule_relationship: TripDescriptor.ScheduleRelationship = betterproto.enum_field(
        4
    )
...
class EntitySelector(betterproto.Message):
    ...
    trip: "RipDescriptor" = betterproto.message_field(4)
...
class TranslatedString(betterproto.Message):
    ...
    translation: List[TranslatedString.Translation] = betterproto.message_field(1)
